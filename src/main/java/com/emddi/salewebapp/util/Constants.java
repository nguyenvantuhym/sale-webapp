...
public class Constants {
    ...
    public static Map<String, String> sensorDesMap = new HashMap<>();
    ...
    public static Map<String, String> relayDesMap = new HashMap<>();
    ...
    public static Map<String, String> alarmDesMap = new HashMap<>();
    ...
    //	事件描述
    public static Map<String, String> allEventMap = new HashMap<>();
    public static Map<String, String> baseEventMap = new HashMap<>();
