...
public class Db {
    ...
    /*	unexecuted commands */
    public static Map<String, LinkedList<String>> cmdListMap = new HashMap<>();
    /*  event Records	 */
    public static Map<String, LinkedList<String>> rtLogMap = new HashMap<>();
    ...
    static {
        ...
        //Monday
        time.put("mon_start_1", "00:00");
        time.put("mon_start_2", "00:00");
        time.put("mon_start_3", "00:00");
        time.put("mon_end_1", "23:59");
        time.put("mon_end_2", "00:00");
        time.put("mon_end_3", "00:00");

        //Tuesday
        time.put("tue_start_1", "00:00");
        time.put("tue_start_2", "00:00");
        time.put("tue_start_3", "00:00");
        time.put("tue_end_1", "23:59");
        time.put("tue_end_2", "00:00");
        time.put("tue_end_3", "00:00");

        //Wednesday
        time.put("wed_start_1", "00:00");
        time.put("wed_start_2", "00:00");
        time.put("wed_start_3", "00:00");
        time.put("wed_end_1", "23:59");
        time.put("wed_end_2", "00:00");
        time.put("wed_end_3", "00:00");

        //Thursday
        time.put("thu_start_1", "00:00");
        time.put("thu_start_2", "00:00");
        time.put("thu_start_3", "00:00");
        time.put("thu_end_1", "23:59");
        time.put("thu_end_2", "00:00");
        time.put("thu_end_3", "00:00");

        //Friday
        time.put("fri_start_1", "00:00");
        time.put("fri_start_2", "00:00");
        time.put("fri_start_3", "00:00");
        time.put("fri_end_1", "23:59");
        time.put("fri_end_2", "00:00");
        time.put("fri_end_3", "00:00");

        //Saturday
        time.put("sat_start_1", "00:00");
        time.put("sat_start_2", "00:00");
        time.put("sat_start_3", "00:00");
        time.put("sat_end_1", "23:59");
        time.put("sat_end_2", "00:00");
        time.put("sat_end_3", "00:00");

        //Sunday
        time.put("sun_start_1", "00:00");
        time.put("sun_start_2", "00:00");
        time.put("sun_start_3", "00:00");
        time.put("sun_end_1", "23:59");
        time.put("sun_end_2", "00:00");
        time.put("sun_end_3", "00:00");

        //Holiday 1
        time.put("hol1_start_1", "00:00");
        time.put("hol1_start_2", "00:00");
        time.put("hol1_start_3", "00:00");
        time.put("hol1_end_1", "00:00");
        time.put("hol1_end_2", "00:00");
        time.put("hol1_end_3", "00:00");

        //Holiday 2
        time.put("hol2_start_1", "00:00");
        time.put("hol2_start_2", "00:00");
        time.put("hol2_start_3", "00:00");
        time.put("hol2_end_1", "00:00");
        time.put("hol2_end_2", "00:00");
        time.put("hol2_end_3", "00:00");

        //Holiday 3
        time.put("hol3_start_1", "00:00");
        time.put("hol3_start_2", "00:00");
        time.put("hol3_start_3", "00:00");
        time.put("hol3_end_1", "00:00");
        time.put("hol3_end_2", "00:00");
        time.put("hol3_end_3", "00:00");
